...
img1 = cv.imread("./Sample Images/Image_Set_1/OCT_p1.png") # Image to be aligned.
img2 = cv.imread("./Sample Images/Image_Set_1/OCT_p2.png") # Reference image.
img3 = cv.imread("./Sample Images/Image_Set_1/Attenuation_p1.png") # Matching attenuation image
